...
func RunProxyExample() {
	blockIo := proxy()
	fmt.Println("Get Balance: ", blockIo.GetBalance("{}"));
	fmt.Println("Get New Address: ", blockIo.GetNewAddress("{\"label\": \"testDest4\"}"));
	fmt.Println("Withdraw from labels: ", blockIo.WithdrawFromLabels("{\"from_labels\": \"default\", \"to_label\": \"testDest4\", \"amount\": \"0.003\"}"));
	fmt.Println("Get Address Balance: ", blockIo.GetAddressBalance("{\"labels\": \"default, testDest4\"}"));
